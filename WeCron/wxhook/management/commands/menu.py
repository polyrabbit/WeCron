    ...
    def handle(self, *args, **options):
        new_menu = {"button": [
            {"name": "我的提醒", "sub_button": [
                {"url": "http://wecron.betacat.io/reminds/", "type": "view", "name": "所有提醒", "sub_button": []}, {"type": "click", "name": "明天", "key": "time_remind_tomorrow", "sub_button": []}, {"type": "click", "name": "今天", "key": "time_remind_today", "sub_button": []}]},
