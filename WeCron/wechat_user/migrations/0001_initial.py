    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscribe', models.NullBooleanField(choices=[(False, '\u672a\u5b9a\u9605'), (True, '\u5df2\u8ba2\u9605')], default=False, verbose_name='\u662f\u5426\u8ba2\u9605')),
                ...
                ('morning_greeting', models.TimeField(default='08:00', null=True, verbose_name='\u65e9\u62a5\u65f6\u95f4')),
                ('notify_subscription', models.NullBooleanField(default=True, verbose_name='\u63d0\u9192\u88ab\u8ba2\u9605\u901a\u77e5')),
                ('timezone', models.CharField(default=b'Asia/Shanghai', max_length=64, verbose_name='\u9ed8\u8ba4\u65f6\u533a')),
                ('source', models.CharField(max_length=32, null=True, verbose_name='\u7528\u6237\u6765\u6e90\uff0c\u533a\u5206\u4ece\u90a3\u4e2a\u516c\u4f17\u53f7\u5173\u6ce8\u8fc7\u6765')),
            ],
            options={
